...
## Usage
Please see [godoc.org](http://godoc.org/github.com/PiotrKozimor/gatt) for documentation.
...
Please check [#32](https://github.com/PiotrKozimor/gatt/issues/32) for the status of this issue.
